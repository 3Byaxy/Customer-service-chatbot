import { AgentResponse } from './ai-agents.js'
...
class LanguageDetector {
  ...
  async detectAndRoute(text: string): Promise<LanguageDetection> {
    const detection = this.detectLanguage(text)

    // Route to appropriate AI agent based on detected language
    const agentResponse = await aiAgentsService.routeToAgent(text, detection.primaryLanguage)
